...
export class SssControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: Sss })
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [Sss] })
  ...
  async findMany(@common.Req() request: Request): Promise<Sss[]> {
    const args = plainToClass(SssFindManyArgs, request.query);
  ...
  async findOne(
    @common.Param() params: SssWhereUniqueInput
  ): Promise<Sss | null> {
  ...
  async update(
    @common.Param() params: SssWhereUniqueInput,
    @common.Body() data: SssUpdateInput
  ): Promise<Sss | null> {
    try {
